  ...
  return (
    <StyledCompletions id="Realizacje">
      <Heading TextColor="--primary-color">
        Realizacje w których braliśmy udział
      </Heading>
      <StyledCards>{nodes}</StyledCards>
      <div id="galeria"></div>
      {galleryIndex !== null ? (
        <>
          <Heading TextColor="--primary-color">
            {data[galleryIndex].name}
          </Heading>

          <Gallery
            imagesList={data[galleryIndex].photos}
            folder={data[galleryIndex].folder}
          ></Gallery>
        </>
      ) : (
        ""
